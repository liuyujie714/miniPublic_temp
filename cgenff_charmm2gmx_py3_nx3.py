...
# USAGE: python cgenff_charmm2gmx_py3_nx3.py DRUG drug.mol2 drug.str charmm36.ff
# Tested with Python >= 3.0, Requires numpy and networkx
# The networkx version MUST be >= 2.5. Tested version: 3.0
...
nxver = float('.'.join(str(i) for i in nx.__version__.split('.')[:2]))
if(nxver < 2.0):
	...
	print("This script has been tested with NetworkX 3.0")
	print("Please install version 3.0 for best performance:")
	print("pip uninstall networkx")
	print("pip install networkx==3.0")
	exit()
...
print("NOTE 1: Code tested with Python 3.8 and 3.10. Your version:",sys.version)
print("")
print("NOTE 2: Code tested with NetworkX 3.0. Your version:",nx.__version__)
print("")
